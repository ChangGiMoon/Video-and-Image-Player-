...
class VideoPlayer(object):
    ...
    def __get_video(self, file_path, file_name, delay_time, save, save_interval, made_save_path, save_file_extension):
        ...
        if not delay_time:  # set delay time using fps
            delay_time = int(video.get(cv2.CAP_PROP_FPS))
        ...
        while video.isOpened():
            ...
            if save and frame_counter % save_interval == 0:
                save_filename = file_name + "_" + str(frame_counter).zfill(5) + "." + save_file_extension
            ...
            cv2.putText(frame, "#: "+str(frame_counter), (frame.shape[1]-80, 15),
